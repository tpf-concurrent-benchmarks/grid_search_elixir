...
defmodule Interval do
  ...
  # TODO: add this to an utils module or make private
  def _round(value, precision) do
    rounded_result =
      case value do
  ...
  def split_evenly(interval, n_partitions) do
    for j <- 0..(round(n_partitions) - 1) do
      ...
      sub_end =
        _round(
          interval.start + (j + 1) * interval.size / n_partitions * interval.step,
          interval.precision
        )
